...
app.use('/api/salary-revision-mail-drafts', require('./routes/salaryRevisionMailDrafts'));
app.use('/api/confirmation-mail-drafts', require('./routes/confirmationMailDrafts'));
