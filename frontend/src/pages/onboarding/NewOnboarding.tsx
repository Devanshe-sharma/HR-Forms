...
const schema = z.object({
  ...
  employeeCategory: z.enum(["Employee", "Consultant", "Intern", "Intern with PPO", "Contract Based", "Part Time", "Temporary Staffing" ]).optional(),
...
// checklist/email treatment as plain "Intern".
function isInternCategory(employeeCategory?: string): boolean {
  return (employeeCategory || "").trim().toLowerCase().startsWith("intern");
}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="max-w-5xl mx-auto px-6 py-8 space-y-8">
              ...
              <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(["Employee", "Consultant", "Intern", "Intern with PPO", "Contract Based", "Part Time", "Temporary Staffing"] as const).map((cat) => (
                    <label
                      key={cat}
