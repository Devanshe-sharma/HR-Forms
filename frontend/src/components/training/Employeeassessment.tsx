        ...
        <>
          ...
          {fileVal ? (
            ...
            <button type="button" onClick={() => ref.current?.click()}
              className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5 border-2 border-dashed border-gray-300 rounded-md text-xs text-gray-500 hover:border-blue-400 hover:text-blue-600 transition-colors">
...
export default function EmployeeAssessment() {
  ...
  if (view === 'upload' && selectedTraining) {
    return (
      <div className="p-6 max-w-2xl">
        ...
        <h2 className="text-base text-gray-700 mb-1">Upload Training Content</h2>
    ...
    return (
      <div className="p-6 max-w-2xl">
        ...
        {submitted ? (
          ...
          /* Question form */
          <>
            <h2 className="text-base text-gray-700 mb-1">Assessment</h2>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-40 text-xs">
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-base text-gray-700 mb-1">Employee Assessment</h2>
            ...
            return (
              <div key={t._id} className="bg-white border border-gray-200 rounded-xl p-3 flex flex-col gap-2 hover:shadow-sm transition-shadow">
                ...
                <div className="flex gap-2 text-xs">
                  <span className={`flex items-center gap-0.5 ${t.contentPdfLink ? 'text-green-600' : 'text-gray-300'}`}>
                  ...
                  <span className={`flex items-center gap-1 ${t.assessmentLink ? 'text-green-600' : 'text-gray-300'}`}>
                    <FileCheck className="w-3 h-3" /> Assessment
                  </span>
                </div>

                {/* Assessment result badge */}
                {myResult && (
                  <div className={`flex items-center gap-1 text-xs px-1.5 py-0.5 rounded-full w-fit
                ...
                <div className="flex gap-1 mt-auto pt-1">
                  ...
                  {isTrainer && (
                    <button onClick={() => openUpload(t)}
                      className="flex items-center gap-1 px-2 py-1 text-xs border border-blue-300 text-blue-600 rounded-md hover:bg-blue-50 transition-colors">
                  ...
                  {!isTrainer && !uploaded && (
                    <span className="flex items-center gap-1 text-xs text-gray-400">
                      <Clock className="w-3 h-3" /> Awaiting content upload
                    </span>
                  )}
                </div>
              </div>
